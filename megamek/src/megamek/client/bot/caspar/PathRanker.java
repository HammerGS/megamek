...
public abstract class PathRanker implements IPathRanker {
    ...
    // Control state
    // PathRanker classes should be pretty stateless, except pointers to Caspar
    // and such

    /**
     * The possible path ranker types. If you're adding a new one, add it here then make sure to add it to
     * Caspar.InitializePathRankers
     */
    ...
    public PathRanker(Caspar Caspar) {
        owner = Caspar;
    }
    ...
    public Targetable findClosestEnemy(Entity me, Coords position, Game game,
        ...
        var ignoredTargets = owner.getCasparSettings().getIgnoredUnitTargets();
