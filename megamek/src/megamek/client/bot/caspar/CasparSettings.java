 ...
 */
public class CasparSettings implements Serializable {
    private static final MMLogger logger = MMLogger.create(CasparSettings.class);
    ...
    private String description = CasparSettingsFactory.DEFAULT_BEHAVIOR_DESCRIPTION;
    ...
    public CasparSettings getCopy() throws CasparException {
        final CasparSettings copy = new CasparSettings();
    ...
    /**
     * Sets the name for this type of behavior. Must be unique in order to save. Throws a CasparException when the
     * description is empty.
     *
     * @param description The name to be used.
     */
    public void setDescription(final String description) throws CasparException {
        if (StringUtility.isNullOrBlank(description)) {
            throw new CasparException("Description is required!");
        }
        this.description = description.trim();
    }

    /**
     * A list of hexes that Caspar will attempt to move to and attack.
     *
     * @return A list of hexes that Caspar will attempt to move to and attack.
     */
    ...
    /**
     * Adds a target that Caspar will attempt to move to and attack.
     *
    ...
    /**
     * Removes a target that Caspar will attempt to move to and attack.
     *
    ...
    /**
     * @return A list of enemy units that Caspar will ignore completely.
     */
    ...
    /**
     * @return A list of enemy units that Caspar will prioritize over others.
     */
    ...
    /**
     * When this is true, Caspar will follow the Forced Withdrawal rules from Total Warfare.
     *
     * @return Should Caspar follow the Forced Withdrawal rules?
     */
     ...
     * When this is true, Caspar will follow the Forced Withdrawal rules from Total Warfare.
     *
     * @param forcedWithdrawal Should Caspar follow the Forced Withdrawal rules?
     */
     ...
     * @param index The index of the Bravery modifier to be used.
     */
    public void setBraveryIndex(final String index) throws CasparException {
        try {
            setBraveryIndex(Integer.parseInt(index));
        } catch (final NumberFormatException ex) {
            throw new CasparException(ex);
        }
    }
     ...
     * @param index The index of my current {@link #FALL_SHAME_VALUES}.
     */
    public void setFallShameIndex(final String index) throws CasparException {
        try {
     ...
     * @param index The index ["0"-"10"] of the herd mentality value that should be used.
     */
    public void setHerdMentalityIndex(final String index) throws CasparException {
        try {
     ...
     * Caspar's home edge.
     *
     * @return The {@link CardinalEdge} Caspar will flee to.
     */
     ...
     * Caspar's home edge.
     *
     * @param destinationEdge The {@link CardinalEdge} Caspar should flee to.
     */
     ...
     * Caspar's home edge.
     *
     * @param destinationEdge the index of the {@link CardinalEdge} Caspar should flee to. See
    ...
    public void setDestinationEdge(final String destinationEdge) throws CasparException {
        try {
            setDestinationEdge(Integer.parseInt(destinationEdge.trim()));
        } catch (final NumberFormatException e) {
            throw new CasparException("Invalid destinationEdge value.", e);
        }
    }
     ...
     * Caspar's home edge.
     *
     * @param retreatEdge The {@link CardinalEdge} Caspar should flee to.
     */
     ...
     * Caspar's home edge.
     *
     * @param retreatEdge the index of the {@link CardinalEdge} Caspar should flee to. See
     *                    {@link CardinalEdge#getIndex()}
     */
     ...
     *                    {@link CardinalEdge#getIndex()}
     */
    public void setRetreatEdge(final String retreatEdge) throws CasparException {
        try {
            setRetreatEdge(Integer.parseInt(retreatEdge.trim()));
        } catch (final NumberFormatException e) {
            throw new CasparException("Invalid retreatEdge value.", e);
        }
    }
    ...
    public void setAntiCrowding(String antiCrowding) throws CasparException {
        try {
    ...
    public void setNumberOfEnemiesToConsiderFacing(String numberOfEnemiesToConsiderFacing) throws CasparException {
        try {
    ...
    public void setAllowFacingTolerance(String allowFacingTolerance) throws CasparException {
        try {
    ...
    public void setFavorHigherTMM(String favorHigherTMM) throws CasparException {
        try {
     ...
     */
    public void setHyperAggressionIndex(final String index) throws CasparException {
        try {
     ...
     */
    public void setSelfPreservationIndex(final String index) throws CasparException {
        try {
    ...
    boolean fromXml(final Element behavior) throws CasparException {
    ...
    public boolean isDefault() {
        return CasparSettingsFactory.DEFAULT_BEHAVIOR_DESCRIPTION.equalsIgnoreCase(description);
    }
     ...
     */
    public String toLog() {
        final StringBuilder out = new StringBuilder("Caspar Behavior: ").append(getDescription());
    ...
    public boolean equals(final Object o) {
        if (this == o) {
            return true;
        } else if (!(o instanceof CasparSettings)) {
            return false;
        }

        final CasparSettings that = (CasparSettings) o;
