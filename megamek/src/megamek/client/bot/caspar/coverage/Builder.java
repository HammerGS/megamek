 ...
 */
package megamek.client.bot.caspar.coverage;

import static megamek.client.bot.caspar.FiringPlanCalculationParameters.FiringPlanCalculationType.GET;
import static megamek.client.bot.caspar.FiringPlanCalculationParameters.FiringPlanCalculationType.GUESS;

import java.util.HashMap;
import java.util.Map;

import megamek.client.bot.caspar.EntityState;
import megamek.client.bot.caspar.FiringPlanCalculationParameters;
