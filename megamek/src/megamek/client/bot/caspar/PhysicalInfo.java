...
public class PhysicalInfo {
     ...
     *
     */
    protected PhysicalInfo(Caspar owner) {
        this.owner = owner;
    }
     ...
     * @param shooterState       The current {@link megamek.client.bot.caspar.EntityState} of the attacker.
     * @param target             The {@link megamek.common.units.Targetable} of the attack.
     * @param targetState        The current {@link megamek.client.bot.caspar.EntityState} of the target.
     * @param physicalAttackType The type of attack being made.
     * @param game               The current {@link Game}
     * @param owner              The owning {@link Caspar} bot.
    ...
    PhysicalInfo(Entity shooter, EntityState shooterState, Targetable target, EntityState targetState,
          PhysicalAttackType physicalAttackType, Game game, Caspar owner, boolean guess) {
     ...
     * @param guess              Set TRUE to estimate the chance to hit rather than doing the full calculation.
     */
    PhysicalInfo(Entity shooter, Targetable target, PhysicalAttackType physicalAttackType, Game game, Caspar owner,
          boolean guess) {
