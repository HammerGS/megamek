...
public class PriorityTargetCommand implements ChatCommand {
    ...
    public List<Argument<?>> defineArguments() {
        return List.of(
              new UnitArgument(UNIT_ID, Messages.getString("Caspar.command.priorityTarget.unitID"))
        );
    }
    ...
    public void execute(Caspar Caspar, Arguments arguments) {
        ...
        Caspar.getCasparSettings().addPriorityUnit(unitArg.getValue());
        Caspar.sendChat(Messages.getString("Caspar.command.priorityTarget.success"));
    }
}
