...
public interface ChatCommand {
     ...
     * Execute the command.
     *
     * @param Caspar  The bot
     * @param arguments The arguments for the command
     */
    void execute(Caspar Caspar, Arguments arguments);

    /**
     * Get instance of a common argument to keep Caspar quiet while executing the commands.
     *
     * @return BooleanArgument to keep Caspar quiet
     */
    default BooleanArgument quietArgument() {
        return new BooleanArgument(QUIET, Messages.getString("Caspar.command.quiet"), false);
    }
