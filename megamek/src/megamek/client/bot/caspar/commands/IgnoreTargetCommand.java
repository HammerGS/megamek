...
public class IgnoreTargetCommand implements ChatCommand {
    ...
    public List<Argument<?>> defineArguments() {
        return List.of(
              new UnitArgument(UNIT_ID, Messages.getString("Caspar.command.ignoreTarget.unitID"))
        );
    }
    ...
    public void execute(Caspar Caspar, Arguments arguments) {
        ...
        Caspar.getCasparSettings().addIgnoredUnitTarget(unitArg.getValue());
        Caspar.sendChat(Messages.getString("Caspar.command.ignoreTarget.targetAdded", unitArg.getValue()));
    }
}
