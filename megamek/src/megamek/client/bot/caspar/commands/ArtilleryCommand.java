...
import megamek.client.bot.caspar.ArtilleryCommandAndControl;
...
public class ArtilleryCommand implements ChatCommand {
    ...
    public List<Argument<?>> defineArguments() {
        return List.of(
              new EnumArgument<>(ORDER,
                    Messages.getString("Caspar.command.artillery.order"),
                    ArtilleryCommandAndControl.ArtilleryOrder.class),
              new EnumArgument<>(AMMO,
                    Messages.getString("Caspar.command.artillery.ammo"),
              ...
              new NotRequiredMultiHexNumberArgument(TARGET,
                    Messages.getString("Caspar.command.artillery.targetHex"))
        );
    }
    ...
    public void execute(Caspar Caspar, Arguments arguments) {
        ...
        var artilleryCommandAndControl = Caspar.getArtilleryCommandAndControl();
        ...
        if (!artilleryOrder.equals(ArtilleryCommandAndControl.ArtilleryOrder.AUTO) && !artilleryOrder.equals(
            ...
            if (multiHexNumberArgument.getValue().isEmpty()) {
                Caspar.sendChat(Messages.getString("Caspar.command.artillery.noTargets"));
                return;
            }
