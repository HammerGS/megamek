...
/**
 * Method for handling morale with Caspar.
 *
...
public class MoraleUtil {
    ...
    /**
     * Triggers the morale check for all units controlled by the Caspar bot player.
     *
     * @param forcedWithdrawal Set TRUE if Forced Withdrawal is in effect.
     * @param bravery          The index of the bravery setting in {@link CasparSettings}.
     * @param selfPreservation The index of the selfPreservation setting in {@link CasparSettings}.
     * @param player           The {@link Player} of the Caspar bot.
