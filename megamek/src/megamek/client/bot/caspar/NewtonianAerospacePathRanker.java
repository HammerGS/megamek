...
public class NewtonianAerospacePathRanker extends BasicPathRanker {
    public NewtonianAerospacePathRanker(Caspar owningCaspar) {
        super(owningCaspar);
    }
    ...
    public Entity findClosestEnemy(Entity me, Coords position, Game game) {
        ...
        var ignoredTargets = getOwner().getCasparSettings().getIgnoredUnitTargets();
        var priorityTargets = getOwner().getCasparSettings().getPriorityUnitTargets();
