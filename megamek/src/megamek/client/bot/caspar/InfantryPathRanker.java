...
public class InfantryPathRanker extends BasicPathRanker {
    ...
    public InfantryPathRanker(Caspar Caspar) {
        super(Caspar);

        setPathEnumerator(Caspar.getPrecognition().getPathEnumerator());
    }
    ...
    protected RankedPath rankPath(MovePath path, Game game, int maxRange, double fallTolerance,
        ...
        formula.append("Calculation: {braveryMod [")
              ...
              .append(" * ")
              .append(getOwner().getCasparSettings().getHyperAggressionValue())
              .append("] - herdingMod [")
              .append(herdingMod)
              .append(" = ")
              .append(distanceToClosestEnemy(movingUnit, path.getFinalCoords(), game))
              .append(" * ")
              .append(getOwner().getCasparSettings().getHerdMentalityValue())
        ...
        logger.trace(
              ...
              getOwner().getCasparSettings().getHyperAggressionValue(),
              herdingMod,
              distanceToClosestEnemy(movingUnit, path.getFinalCoords(), game),
              getOwner().getCasparSettings().getHerdMentalityValue(),
              selfPreservationMod);
