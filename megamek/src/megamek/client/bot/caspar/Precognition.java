...
public class Precognition implements Runnable {
    ...
    private final Caspar owner;

    /**
     * Precognition's version of the game, which should mirror the game in Caspar, but should not be the same
     * reference. If Precognition and Caspar share the same game reference, then this will cause concurrency issues.
     */
    ...
    public Precognition(Caspar owner) {
        this.owner = owner;
        this.game = new Game();
        ...
        // Initialize ECM Info, especially important if Caspar added mid-game
     ...
     * ensures that Precognition's Game instance stays up-to-date with Caspar's instance of Game.
     *
