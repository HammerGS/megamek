...
import megamek.client.ui.dialogs.helpDialogs.CasparHelpDialog;
...
/** A dialog box to configure CASPAR bot properties. */
public class CasparConfigDialog extends AbstractButtonDialog
      implements ActionListener, ListSelectionListener, ChangeListener {
    private final static MMLogger logger = MMLogger.create(CasparConfigDialog.class);
    ...
    private final transient CasparSettingsFactory casparSettingsFactory = CasparSettingsFactory.getInstance();
    private CasparSettings casparBehavior;

    private final JLabel nameLabel = new JLabel(Messages.getString("CasparConfigDialog.nameLabel"));
    private final TipTextField nameField = new TipTextField("", 16);

    private final JButton addTargetButton = new TipButton(Messages.getString("CasparConfigDialog.addHexTarget"));
    private final JButton addUnitButton = new TipButton(Messages.getString("CasparConfigDialog.addUnitTarget"));
    private final JButton removeTargetButton = new TipButton(Messages.getString("CasparConfigDialog.removeTarget"));
    ...
    private final MMToggleButton forcedWithdrawalCheck = new TipMMToggleButton(Messages.getString(
          "CasparConfigDialog.forcedWithdrawalCheck"));

    private final MMToggleButton iAmAPirateCheck =
          new TipMMToggleButton(Messages.getString("CasparConfigDialog.iAmAPirateCheck"));
    private final MMToggleButton ignoreDamageOutputCheck =
          new TipMMToggleButton(Messages.getString("CasparConfigDialog.ignoreDamageOutput"));
    private final MMToggleButton exclusiveHerdingCheck =
          new TipMMToggleButton(Messages.getString("CasparConfigDialog.exclusiveHerdingCheck"));
    private final MMToggleButton experimentalCheck =
          new TipMMToggleButton(Messages.getString("CasparConfigDialog.experimentalCheck"));

    private final JLabel withdrawEdgeLabel = new JLabel(Messages.getString("CasparConfigDialog.retreatEdgeLabel"));
    ...
    private final MMToggleButton autoFleeCheck = new TipMMToggleButton(Messages.getString(
          "CasparConfigDialog.autoFleeCheck"));
    private final JLabel fleeEdgeLabel = new JLabel(Messages.getString("CasparConfigDialog.homeEdgeLabel"));
    ...
    private final TipSlider numberOfEnemiesToConsiderFacingSlidebar = new TipSlider(SwingConstants.HORIZONTAL,
          CasparSettings.MIN_NUMBER_OF_ENEMIES_TO_CONSIDER_FACING,
          CasparSettings.MAX_NUMBER_OF_ENEMIES_TO_CONSIDER_FACING,
          CasparSettings.DEFAULT_NUMBER_OF_ENEMIES_TO_CONSIDER_FACING);
    private final TipSlider allowFacingToleranceSlidebar = new TipSlider(SwingConstants.HORIZONTAL,
          CasparSettings.MIN_ALLOW_FACING_TOLERANCE,
          CasparSettings.MAX_ALLOW_FACING_TOLERANCE,
          CasparSettings.DEFAULT_ALLOW_FACING_TOLERANCE);

    private final TipButton savePreset = new TipButton(Messages.getString("CasparConfigDialog.save"));
    private final TipButton saveNewPreset = new TipButton(Messages.getString("CasparConfigDialog.saveNew"));

    private final JButton casparHelpButton = new JButton(Messages.getString("CasparConfigDialog.help"));

    private final JLabel chooseLabel = new JLabel(Messages.getString("CasparConfigDialog.behaviorNameLabel"));
    /**
    ...
    public CasparConfigDialog(JFrame parent, @Nullable String botName) {
        this(parent, botName, null, null);
    }

    public CasparConfigDialog(JFrame parent, @Nullable String botName, @Nullable CasparSettings behavior,
          @Nullable ClientGUI cg) {
        super(parent, "CasparConfigDialog", "CasparConfigDialog.title");
        fixedBotPlayerName = botName;
        isNewBot = botName == null;
        clientGui = cg;
        client = cg != null ? cg.getClient() : null;
        casparBehavior = (behavior != null) ? behavior : new CasparSettings();
    ...
    /**
     * The setting section contains the presets list on the left side and the caspar settings on the right.
     */
    private JPanel settingSection() {
        var casparScroll = new JScrollPane(casparPanel());
        casparScroll.getVerticalScrollBar().setUnitIncrement(16);
        casparScroll.setBorder(null);
        JPanel presetsPanel = presetsPanel();

        var result = new JPanel(new BorderLayout(0, 0));
        result.setAlignmentX(LEFT_ALIGNMENT);
        result.add(casparScroll, BorderLayout.CENTER);
        result.add(presetsPanel, BorderLayout.LINE_START);
        return result;
    }

    /** The caspar panel contains the individual caspar settings. */
    private JPanel casparPanel() {
        JPanel result = new JPanel();
        result.setLayout(new BoxLayout(result, BoxLayout.PAGE_AXIS));
    ...
    private JPanel nameSection() {
        ...
        nameField.setToolTipText(Messages.getString("CasparConfigDialog.namefield.tooltip"));
        // When the dialog configures an existing player, the name must not be changed
        nameField.setText((fixedBotPlayerName == null) ? getFreeCasparName() : fixedBotPlayerName);
    ...
    /**
     * Returns a name that is not used by another player. Starts with "CASPAR" and subsequently adds numbers
     * (CASPAR1 etc.) until a free one is found.
     */
    private String getFreeCasparName() {
        String name = "CASPAR";
        if (client != null) {
            int counter = 0;
    ...
    /** The presets panel has a list of behavior presets for CASPAR. */
    ...
    private JPanel behaviorSection() {
        JPanel result = new OptionPanel("CasparConfigDialog.behaviorSection");
        Content panContent = new Content();
        panContent.setLayout(new BoxLayout(panContent, BoxLayout.PAGE_AXIS));
        result.add(panContent);

        panContent.add(buildSliderWithDynamicTitle(braverySlidebar,
              Messages.getString("CasparConfigDialog.braverySliderMin"),
              Messages.getString("CasparConfigDialog.braverySliderMax"),
              Messages.getString("CasparConfigDialog.braveryTooltip"),
              "CasparConfigDialog.braverySliderTitle"));
        panContent.add(Box.createVerticalStrut(7));

        panContent.add(buildSliderWithDynamicTitle(selfPreservationSlidebar,
              Messages.getString("CasparConfigDialog.selfPreservationSliderMin"),
              Messages.getString("CasparConfigDialog.selfPreservationSliderMax"),
              Messages.getString("CasparConfigDialog.selfPreservationTooltip"),
              "CasparConfigDialog.selfPreservationSliderTitle"));
        panContent.add(Box.createVerticalStrut(7));

        panContent.add(buildSliderWithDynamicTitle(aggressionSlidebar,
              Messages.getString("CasparConfigDialog.aggressionSliderMin"),
              Messages.getString("CasparConfigDialog.aggressionSliderMax"),
              Messages.getString("CasparConfigDialog.aggressionTooltip"),
              "CasparConfigDialog.aggressionSliderTitle"));
        panContent.add(Box.createVerticalStrut(7));

        panContent.add(buildSliderWithDynamicTitle(herdingSlidebar,
              Messages.getString("CasparConfigDialog.herdingSliderMin"),
              Messages.getString("CasparConfigDialog.herdingSliderMax"),
              Messages.getString("CasparConfigDialog.herdingToolTip"),
              "CasparConfigDialog.herdingSliderTitle"));
        panContent.add(Box.createVerticalStrut(7));

        panContent.add(buildSliderWithDynamicTitle(fallShameSlidebar,
              Messages.getString("CasparConfigDialog.fallShameSliderMin"),
              Messages.getString("CasparConfigDialog.fallShameSliderMax"),
              Messages.getString("CasparConfigDialog.fallShameToolTip"),
              "CasparConfigDialog.fallShameSliderTitle"));

        panContent.add(buildSliderWithDynamicTitle(numberOfEnemiesToConsiderFacingSlidebar,
              Messages.getString("CasparConfigDialog.numberOfEnemiesToConsiderFacingMin",
                    CasparSettings.MIN_NUMBER_OF_ENEMIES_TO_CONSIDER_FACING),
              Messages.getString("CasparConfigDialog.numberOfEnemiesToConsiderFacingMax",
                    CasparSettings.MAX_NUMBER_OF_ENEMIES_TO_CONSIDER_FACING),
              Messages.getString("CasparConfigDialog.numberOfEnemiesToConsiderFacingToolTip"),
              "CasparConfigDialog.numberOfEnemiesToConsiderFacingTitle"));
        panContent.add(Box.createVerticalStrut(7));

        panContent.add(buildSliderWithDynamicTitle(allowFacingToleranceSlidebar,
              Messages.getString("CasparConfigDialog.allowFacingToleranceMin"),
              Messages.getString("CasparConfigDialog.allowFacingToleranceMax"),
              Messages.getString("CasparConfigDialog.allowFacingToleranceToolTip",
                    CasparSettings.MAX_ALLOW_FACING_TOLERANCE),
              "CasparConfigDialog.allowFacingToleranceTitle"));
        panContent.add(Box.createVerticalStrut(7));

        if (CLIENT_PREFERENCES.getEnableExperimentalBotFeatures()) {
            panContent.add(buildSliderWithDynamicTitle(antiCrowdingSlidebar,
                  Messages.getString("CasparConfigDialog.antiCrowdingSliderMin"),
                  Messages.getString("CasparConfigDialog.antiCrowdingSliderMax"),
                  Messages.getString("CasparConfigDialog.antiCrowdingToolTip"),
                  "CasparConfigDialog.antiCrowdingTitle"));
            panContent.add(Box.createVerticalStrut(7));

            panContent.add(buildSliderWithDynamicTitle(favorHigherTMMSlidebar,
                  Messages.getString("CasparConfigDialog.favorHigherTMMSliderMin"),
                  Messages.getString("CasparConfigDialog.favorHigherTMMSliderMax"),
                  Messages.getString("CasparConfigDialog.favorHigherTMMToolTip"),
                  "CasparConfigDialog.favorHigherTMMTitle"));
            panContent.add(Box.createVerticalStrut(7));
        }

        exclusiveHerdingCheck.setToolTipText(Messages.getString("CasparConfigDialog.exclusiveHerdingCheckToolTip"));
        exclusiveHerdingCheck.addActionListener(this);
        panContent.add(exclusiveHerdingCheck);

        iAmAPirateCheck.setToolTipText(Messages.getString("CasparConfigDialog.iAmAPirateCheckToolTip"));
        iAmAPirateCheck.addActionListener(this);
        panContent.add(iAmAPirateCheck);

        ignoreDamageOutputCheck.setToolTipText(Messages.getString("CasparConfigDialog.ignoreDamageOutputToolTip"));
        ignoreDamageOutputCheck.addActionListener(this);
        panContent.add(ignoreDamageOutputCheck);

        experimentalCheck.setToolTipText(Messages.getString("CasparConfigDialog.experimentalCheckToolTip"));
        ...
        savePreset.setToolTipText(Messages.getString("CasparConfigDialog.saveTip"));
        buttonPanel.add(savePreset);
        saveNewPreset.addActionListener(this);
        saveNewPreset.setMnemonic(KeyEvent.VK_A);
        saveNewPreset.setToolTipText(Messages.getString("CasparConfigDialog.saveNewTip"));
    ...
    private JPanel targetsSection() {
        JPanel result = new OptionPanel("CasparConfigDialog.targetsSection");
        Content panContent = new Content();
        panContent.setLayout(new BoxLayout(panContent, BoxLayout.PAGE_AXIS));
        result.add(panContent);
        ...
        targetsList.setToolTipText(Messages.getString("CasparConfigDialog.targetsListTip"));
    ...
    private JPanel retreatSection() {
        JPanel result = new OptionPanel("CasparConfigDialog.retreatSection");
        Content panContent = new Content();
        panContent.setLayout(new BoxLayout(panContent, BoxLayout.PAGE_AXIS));
        result.add(panContent);

        autoFleeCheck.setToolTipText(Messages.getString("CasparConfigDialog.autoFleeTooltip"));
        autoFleeCheck.addActionListener(this);
        autoFleeCheck.setMnemonic(KeyEvent.VK_F);

        fleeEdgeCombo.removeItem(CardinalEdge.NONE);
        fleeEdgeCombo.setToolTipText(Messages.getString("CasparConfigDialog.homeEdgeTooltip"));
        fleeEdgeCombo.setSelectedIndex(0);
        fleeEdgeCombo.addActionListener(this);

        forcedWithdrawalCheck.setToolTipText(Messages.getString("CasparConfigDialog.forcedWithdrawalTooltip"));
        ...
        withdrawEdgeCombo.setToolTipText(Messages.getString("CasparConfigDialog.retreatEdgeTooltip"));
    ...
    public CasparSettings getCasparSettings() {
        saveCasparProperties();
        return casparBehavior;
    }

    protected void updatePresetFields() {
        selfPreservationSlidebar.setValue(casparBehavior.getSelfPreservationIndex());
        aggressionSlidebar.setValue(casparBehavior.getHyperAggressionIndex());
        fallShameSlidebar.setValue(casparBehavior.getFallShameIndex());
        herdingSlidebar.setValue(casparBehavior.getHerdMentalityIndex());
        braverySlidebar.setValue(casparBehavior.getBraveryIndex());
        antiCrowdingSlidebar.setValue(casparBehavior.getAntiCrowding());
        favorHigherTMMSlidebar.setValue(casparBehavior.getFavorHigherTMM());
        exclusiveHerdingCheck.setSelected(casparBehavior.isExclusiveHerding());
        iAmAPirateCheck.setSelected(casparBehavior.iAmAPirate());
        experimentalCheck.setSelected(casparBehavior.isExperimental());
        numberOfEnemiesToConsiderFacingSlidebar.setValue(casparBehavior.getNumberOfEnemiesToConsiderFacing());
        allowFacingToleranceSlidebar.setValue(casparBehavior.getAllowFacingTolerance());
        ignoreDamageOutputCheck.setSelected(casparBehavior.isIgnoreDamageOutput());
    }

    private void updateDialogFields() {
        updatePresetFields();

        forcedWithdrawalCheck.setSelected(casparBehavior.isForcedWithdrawal());
        withdrawEdgeCombo.setSelectedItem(casparBehavior.getRetreatEdge());

        autoFleeCheck.setSelected(casparBehavior.shouldAutoFlee());
        fleeEdgeCombo.setSelectedItem(casparBehavior.getDestinationEdge());

        targetsListModel.clear();
        for (String t : casparBehavior.getStrategicBuildingTargets()) {
        ...
        targetsListModel.addAll(casparBehavior.getPriorityUnitTargets());
        updateEnabledStates();
    }
    ...
    protected JPanel createButtonPanel() {
        ...
        casparHelpButton.addActionListener(this);
        casparHelpButton.setMnemonic(KeyEvent.VK_H);
        result.add(casparHelpButton);

        return result;
    }

    private void showCasparHelp() {
        new CasparHelpDialog(getFrame()).setVisible(true);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (e.getSource() == casparHelpButton) {
            showCasparHelp();
    ...
    private void saveAsNewPreset() {
        while (true) {
            ...
            String name = JOptionPane.showInputDialog(getFrame(), Messages.getString("CasparConfigDialog.saveNewPrompt"));
            if (name == null || name.isBlank()) {
                return;
            }
            if (!casparSettingsFactory.getBehaviorNameList().contains(name)) {
            ...
            JOptionPane.showMessageDialog(getFrame(), Messages.getString("CasparConfigDialog.saveNewTaken"));
        }
    }
    ...
    private void saveCasparProperties() {
    ...
    private void presetSelected() {
        if (presetsList.isSelectionEmpty()) {
            ...
            if (presetsList.getSelectedValue().equals(Messages.getString("CasparConfigDialog.previousConfig"))) {
                casparBehavior = saveGameBehavior;
                ...
                casparBehavior = casparSettingsFactory.getBehavior(presetsList.getSelectedValue());
                chosenPreset = casparSettingsFactory.getBehavior(presetsList.getSelectedValue());
            }
            if (casparBehavior == null) {
                casparBehavior = new CasparSettings();
            }
            updatePresetFields();
        }
        updateEnabledStates();
    ...
    private void updatePresets() {
        presets = new ArrayList<>(Arrays.asList(casparSettingsFactory.getBehaviorNames()));

        // Add the Configuration from a save game, if any to the top of the list
        if (saveGameBehavior != null) {
            presets.add(0, Messages.getString("CasparConfigDialog.previousConfig"));
        }
    ...
    private static class PresetsRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected,
            ...
            if (preset.equals(Messages.getString("CasparConfigDialog.previousConfig"))) {
    ...
    private class TargetsRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected,
            ...
            if (value instanceof Coords coords) {
                content = Messages.getString("CasparConfigDialog.hexListIntro", coords.getX() + 1, coords.getY() + 1);
                if (client != null) {
                    ...
                    if (board == null) {
                        content += Messages.getString("CasparConfigDialog.hexListNoMp");
                    } else if (!board.contains(coords)) {
                        content += Messages.getString("CasparConfigDialog.hexListOuts");
                    } else if (!board.getHex(coords).containsAnyTerrainOf(BUILDING, FUEL_TANK, BRIDGE)) {
                        content += Messages.getString("CasparConfigDialog.hexListNoBg");
                    } else {
                ...
                if (optEntity.isPresent()) {
                    ...
                    content = Messages.getString("CasparConfigDialog.unitListEntry", unitID, entity.getShortNameRaw());
                    invalid = false;
                } else {
                    content = Messages.getString("CasparConfigDialog.unitListEntryNone", unitID);
                }
            }
    ...
    static String buildingInfoIfPresent(Coords coords, Board board) {
        ...
        if (hex.containsTerrain(BUILDING)) {
            content += Messages.getString("CasparConfigDialog.hexListBldg",
            ...
            content += Messages.getString("CasparConfigDialog.hexListFuel",
                  hex.terrainLevel(FUEL_TANK_CF),
                  hex.terrainLevel(FUEL_TANK_MAGN));
        } else {
            content += Messages.getString("CasparConfigDialog.hexListBrdg",
                  bldg.getBuildingType().toString(),
